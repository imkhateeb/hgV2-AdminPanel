...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      " h-12  px-4  text-left text-[16px]  align-middle  font-extrabold  text-white [&:has([role=checkbox])]:pr-0 dark:text-gray-400",
      className
    )}
    {...props} />
))
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(" p-4 text-[16px] align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props} />
))
